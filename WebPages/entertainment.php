...
session_start();
	...
	$sql = "SELECT * FROM news WHERE SiteName = 'independent' AND CategoryID = '9' ORDER BY ID DESC LIMIT 10";
	$sql2 = "SELECT * FROM news WHERE SiteName = 'bbc' AND CategoryID = '9' ORDER BY ID DESC LIMIT 10";
	$sql3 = "SELECT * FROM news WHERE SiteName = 'guardian' AND CategoryID = '9' ORDER BY ID DESC LIMIT 10";
 ?>

 <!DOCTYPE html>
 <html>
 <head>
 	<title>Spill The Taigh - Entertainment Page</title>
...
<!-- Container for displaying 3 columns -->
<div class = "containerOne">
 	<h1><ul>Home of Entertainment</ul></h1>
 	</div>

 	<br>
 	<div class = "row">
 <div class="column">
 	<!-- Displays Independent news -->
 	<h2>Independent</h2>	
