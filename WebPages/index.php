...
session_start();
	...
	$sql = "SELECT * FROM news WHERE SiteName = 'independent' ORDER BY ID DESC LIMIT 5";
	$sql2 = "SELECT * FROM news WHERE SiteName = 'guardian' ORDER BY ID DESC LIMIT 5";
	$sql3 = "SELECT * FROM news WHERE SiteName = 'sky' ORDER BY ID DESC LIMIT 8";
	$sql4 = "SELECT * FROM news WHERE SiteName = 'cbs' ORDER BY ID DESC LIMIT 5";
	$sql5 = "SELECT * FROM news WHERE SiteName = 'bbc' ORDER BY ID DESC LIMIT 5";
 ?>

 <!DOCTYPE html>
 <html>
 <head>
 	<title>Spill The Taigh - Index Page</title>
...
<div class = "containerOne">
 	<h1><ul>Home of News</ul></h1>
 	</div>

 	<br>
 	<!-- Welcome Message -->
 	<p>Hello, <?php echo $user_data['Forename']; ?></p>
 	<div class = "row">
 <div class="column">
 	<!-- Pulls independent news -->
 	<h2>Independent</h2>	
		<table class="content-table">
			...
			echo"<tr><td>". $row["SiteName"] . "</td><td><a href = 'https://www.independent.co.uk" . $row["ArticleID"] . "'>"
...
<!-- Displays Twitter Widget -->
	<div class="column">

		<a class="twitter-timeline" data-height="400" data-theme="light" href="https://twitter.com/BBCNews?ref_src=twsrc%5Etfw">Tweets by BBCNews</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
