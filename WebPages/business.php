...
session_start();
	...
	$sql = "SELECT * FROM news WHERE SiteName = 'independent' AND CategoryID = '5' ORDER BY ID DESC LIMIT 10";
	$sql2 = "SELECT * FROM news WHERE SiteName = 'bbc' AND CategoryID = '5' ORDER BY ID DESC LIMIT 10";
	$sql3 = "SELECT * FROM news WHERE SiteName = 'guardian' AND CategoryID = '5' ORDER BY ID DESC LIMIT 10";
 ?>

 <!DOCTYPE html>
 <html>
 <head>
 	<title>Spill The Taigh - Business</title>
