...
independent_r1 = requests.get('https://www.theguardian.com/politics')
...
for n in np.arange(0,number_of_articles):
    ...
    try:
        body = soup_sub_article.find_all('div', class_='dcr-i08q0e' or 'dcr-j7ihvk')
        x = body[0].find_all('p')
    except IndexError:  
        pass
    ...
    try:
        add_news = ("INSERT IGNORE INTO news"
                    ...
                    "VALUES (%s, %s, %s, %s, %s , %s)")
        data_news = (link,"1", 'guardian',title, final_article, date_publish_baseline[0].get_text())
        #insertion
