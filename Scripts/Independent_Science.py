...
independent_r1 = requests.get('https://www.independent.co.uk/climate-change')
...
for n in np.arange(0,number_of_articles):
    ...
    try:
        add_news = ("INSERT IGNORE INTO news"
                    ...
                    "VALUES (%s, %s, %s, %s, %s , %s)")
        data_news = (link,"7", 'independent',title, final_article, date_publish_baseline[0].get_text())
        #insertion
