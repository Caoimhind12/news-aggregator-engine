...
independent_r1 = requests.get('https://www.theguardian.com/uk/film')
...
for n in np.arange(0,number_of_articles):
    ...
    try:
        body = soup_sub_article.find_all('div', class_='dcr-7sthwg')
        x = body[0].find_all('p')
    except IndexError:
        pass
    ...
    try:
        add_news = ("INSERT IGNORE INTO news"
                    ...
                    "VALUES (%s, %s, %s, %s, %s , %s)")
        data_news = (link,"9", 'guardian',title, final_article, date_publish_baseline[0].get_text())
        #insertion
